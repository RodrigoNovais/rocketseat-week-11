...
const NewIncident: React.FC = () => {
    ...
    const handleNewIncident = async (e: React.FormEvent) => {
        ...
        api.post('incidents', data, { headers: { Authorization: ngoId }})
            .then(response => history.push('/profile'))
            .catch(error => alert('Erro ao cadastrar caso, tente novamente'))
    }
        ...
        <div className="new-incident-container">
            <div className="content">
                ...
                <form onSubmit={handleNewIncident}>
                    ...
                    <textarea name="" id="" placeholder="Descrição" value={description} onChange={e => setDescription(e.target.value)} />
